...
#routes.txt should be a file that has a single line for each ship like: ship planet planet planet planet.... etc. The first planet in the route will be the first planet in each repeat.
